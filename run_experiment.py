...
parser.add_argument('--learner', default='MostCommon', choices=learners.LEARNERS.keys(),
...
parser.add_argument('--data_source', default='dev', choices=datasets.SOURCES.keys(),
...
def main():
    ...
    m = [metrics.cer, metrics.char_errors, metrics.sent_errors, metrics.ref_lens]
